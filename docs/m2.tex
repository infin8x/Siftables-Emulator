...
The data flow diagrams are shown on the following pages, beginning with the level 0 diagram which is followed by the more specific diagrams.
%\newpage

        \includegraphics[angle=90,width=6.5in,height=9in]{pdfs/dfds/DFD0.pdf} \newpage
        \includegraphics[angle=90,width=6.5in,height=9in]{pdfs/dfds/DFD1-1.pdf} \newpage
        \includegraphics[angle=90,width=6.5in,height=9in]{pdfs/dfds/DFD1-2.pdf} \newpage
        \includegraphics[angle=90,width=6.5in,height=9in]{pdfs/dfds/DFD1-3.pdf} \newpage
        \includegraphics[angle=90,width=6.5in,height=9in]{pdfs/dfds/DFD1-4.pdf} \newpage
        \includegraphics[angle=90,width=6.5in,height=9in]{pdfs/dfds/DFD1-5.pdf} \newpage
        \includegraphics[angle=90,width=6.5in,height=9in]{pdfs/dfds/DFD1-6.pdf} \newpage
