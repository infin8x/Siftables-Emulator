...
\clearpage
              ...
              Sifteo\index{Sifteo} has plans to release an \gls{API} of their own for the Cubes; Singularity will attempt to make our \gls{API} shadow much of the language and functionality of the official Sifteo \gls{API}. 
