...
\subsection{Process}
A basic prototype of the Siftables Emulator was developed using Flash in order to conduct the usability test. The prototype, which modeled the basic functionality intended for the final emulator, was then compared to the current Sifteo emulator, the Siftulator. The tests were conducted using CSSE students and faculty as subjects as they were found to be the best representation of the post-development use demographic. \\\\
Participants in the study were first presented with an informed consent form and a pre-test questionnaire containing inquiries for personal criteria. Upon completion of these two documents, the user was then taken into the testing area and briefly given a basic set of verbal instructions by one of the team members. After the team member finished dictating the instructions and departed, the participant was asked to begin the study by watching a short video demonstrating the capabilities of the Sifteo Cubes. Singularity Software felt that this was the most efficient way to acquaint users with the product, a necessary task for them to be able to accurately judge the performance of an emulator. \\\\
Upon completion of the video, participants were asked to complete a series of simple tasks in the current Siftulator platform. Because of the nature of this product and its lack of a help file, a list of action commands was located on the table next to the user. If they could not intuitively determine the correct way to complete a task, participants were told that this sheet could be used to help them. Users were then asked to switch to Siftables Emulator prototype and reminded that this product was in no way based on the software which they had just used. They were then asked to complete a similar set of tasks using the prototype. In the event that the user became stuck and was unable to complete their task at any time on either emulator, help was offered. This help was kept to a minimum degree, often consisting solely of asking the user a question to help them cogitate in a different fashion. \\\\
At the conclusion of the technical portion of the study, participants were thanked for their time and assistance and asked to complete a posttest questionnaire. This questionnaire was designed to allow each user to express his or her opinion about the various aspects of both projects and suggest possible improvements to the interface of the Siftables Emulator prototype.
