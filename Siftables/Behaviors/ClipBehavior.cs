...
{
    // Class courtesy of: http://www.scottlogic.co.uk/blog/colin/2009/05/silverlight-cliptobounds-can-i-clip-it-yes-you-can/
    public class ClipBehavior
    {
        ...
        public static readonly DependencyProperty ToBoundsProperty =
            ...
            typeof(ClipBehavior), new PropertyMetadata(false, OnToBoundsPropertyChanged));
