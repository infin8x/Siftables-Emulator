...
The emulator must be able to be function on \gls{Windows}\index{Windows}, \gls{Mac}\index{Mac} OS, and \gls{Linux}\index{Linux} operating systems with reasonable hardware and software system requirements.
