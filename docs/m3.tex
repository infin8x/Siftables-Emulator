...
The \index{emulator} will be installable via an executable (on \index{Windows}) or disk image (on \index{Mac}) that will place the program's files in a user-specified directory and create shortcuts as appropriate.
